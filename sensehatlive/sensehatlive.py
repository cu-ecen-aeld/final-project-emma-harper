...
import sensehatlive.rabbitmq as mq
...
def main(args):
    ...
    logger.info('Sense Hat Live!: Consumer')
    sh = mq.RabbitMQConsumer(queue='samples',on_msg_callback=None)
